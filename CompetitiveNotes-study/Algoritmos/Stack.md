---
aliases: [std::stack, LIFO Stack, Pilha]
...
| :--- | :--- | :---: | :---: | :--- |
| [[Stack Monotonica]] | - | - | - | Próximo elemento maior/menor em $O(N)$ |
| [[DFS Iterativa]] | - | - | - | Busca em Profundidade sem RTE de stack overflow |
| [[Algoritmo de Tarjan]] | - | - | - | Componentes Fortemente Conexos (SCCs) |
| [[Algoritmo de Kosaraju]] | - | - | - | Componentes Fortemente Conexos (SCCs) |

**Ligações:** Parsing de Expressões / Validação de Parênteses e Colchetes (Problemas clássicos de sintaxe).
