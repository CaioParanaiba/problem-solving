---
aliases: [std::map, Ordered Map, Red-Black Tree]
...
| :--- | :--- | :---: | :---: | :--- |
| [[Compressão de Coordenadas]] | - | - | - | Alternativa simples quando o tempo é generoso com $O(\log N)$ |
| [[Digit DP]] | - | - | - | Memoização de DP em grafos de estados complexos |
| [[Algoritmo de Mo]] | - | - | - | Contagem de prefixos esparsos |

**Ligações:** Problemas de contagem de subarrays cuja soma é igual a $K$ em matrizes com números negativos.
